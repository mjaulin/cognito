...
public class AuthFilter extends OncePerRequestFilter {
    ...
    AuthFilter(AuthenticationProvider authProvider, AuthService authService,
    ...
    private boolean authenticationIsRequired(HttpServletRequest req, Authentication auth) {
        ...
        return previousAuth == null || !previousAuth.getCredentials().equals(auth.getCredentials()) || (!auth.isAuthenticated() && !pathUnsecured(req));
    }
